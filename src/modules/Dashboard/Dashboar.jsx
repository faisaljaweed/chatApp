  ...
  return (
    <div className="w-screen flex overflow-hidden">
      <div className="w-[25%]  h-screen  bg-white">
        ...
        <hr />
        <div className="ml-14 mt-8 overflow-y-scroll h-[70vh]">
      ...
      <div className="w-[50%] h-screen bg-white flex flex-col items-center">
        <div className="w-[75%] bg-slate-300 h-[50px] mt-8 rounded-full flex items-center px-14">
        ...
        <div className="h-[75%] w-full overflow-scroll border">
        ...
        <div className="p-14">
          <Input
            ...
            className="w-full"
            inputClassName="p-2 px-4 border-0 shadow-lg rounded-full bg-light-gray-100 focus:border-0 focus:ring-0"
          />
        </div>
      </div>
